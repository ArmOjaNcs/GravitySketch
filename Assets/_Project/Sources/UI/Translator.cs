...
namespace Assets.Sources.Utils
{
    public static class Translator
    {
        ...
        new Dictionary<string, Dictionary<string, string>>()
        {
            ...
            { "Return", new () { { "en", "Enter" }, { "ru", "Ввод" }, { "tr", "Enter" } } },
            { "CapsLock", new () { { "en", "Caps Lock" }, { "ru", "Caps Lock" }, { "tr", "Caps Lock" } } },

            // ===== NumPad =====
            { "Keypad0", new () { { "en", "Num 0" }, { "ru", "Num 0" }, { "tr", "Num 0" } } },
            { "Keypad1", new () { { "en", "Num 1" }, { "ru", "Num 1" }, { "tr", "Num 1" } } },
            { "Keypad2", new () { { "en", "Num 2" }, { "ru", "Num 2" }, { "tr", "Num 2" } } },
            { "Keypad3", new () { { "en", "Num 3" }, { "ru", "Num 3" }, { "tr", "Num 3" } } },
            { "Keypad4", new () { { "en", "Num 4" }, { "ru", "Num 4" }, { "tr", "Num 4" } } },
            { "Keypad5", new () { { "en", "Num 5" }, { "ru", "Num 5" }, { "tr", "Num 5" } } },
            { "Keypad6", new () { { "en", "Num 6" }, { "ru", "Num 6" }, { "tr", "Num 6" } } },
            { "Keypad7", new () { { "en", "Num 7" }, { "ru", "Num 7" }, { "tr", "Num 7" } } },
            { "Keypad8", new () { { "en", "Num 8" }, { "ru", "Num 8" }, { "tr", "Num 8" } } },
            { "Keypad9", new () { { "en", "Num 9" }, { "ru", "Num 9" }, { "tr", "Num 9" } } },
            { "KeypadPlus", new () { { "en", "Num +" }, { "ru", "Num +" }, { "tr", "Num +" } } },
            { "KeypadMinus", new () { { "en", "Num -" }, { "ru", "Num -" }, { "tr", "Num -" } } },
            { "KeypadMultiply", new () { { "en", "Num *" }, { "ru", "Num *" }, { "tr", "Num *" } } },
            { "KeypadDivide", new () { { "en", "Num /" }, { "ru", "Num /" }, { "tr", "Num /" } } },
            { "KeypadEnter", new () { { "en", "Num Enter" }, { "ru", "Num Ввод" }, { "tr", "Num Enter" } } },
            { "KeypadPeriod", new () { { "en", "Num ." }, { "ru", "Num ." }, { "tr", "Num ." } } },
            ...
            // ===== Brackets / Russian Х Ъ =====
            { "LeftBracket",  new () { { "en", "[" }, { "ru", "Х" }, { "tr", "[" } } },
            { "RightBracket", new () { { "en", "]" }, { "ru", "Ъ" }, { "tr", "]" } } },
            ...
            // ===== Punctuation =====
            { "Backslash", new () { { "en", "\\" }, { "ru", "\\" }, { "tr", "\\" } } },
            { "Comma",     new () { { "en", "," },  { "ru", "Б" }, { "tr", "," } } },
            { "Period",    new () { { "en", "." },  { "ru", "Ю" }, { "tr", "." } } },
            { "Slash",     new () { { "en", "/" },  { "ru", "." }, { "tr", "/" } } },
            { "Minus",     new () { { "en", "-" },  { "ru", "-" }, { "tr", "-" } } },
            { "Equals",    new () { { "en", "=" },  { "ru", "=" }, { "tr", "=" } } },
